...
public class ConferenceListPresenterTest {
    ...
    */
    ...
    public void setUp() {
        ...
        presenter = new ConferenceListPresenter(dataManager);
        presenter.attachView(mvpView);
    }

    @Test
    public void checkEmptyList() {
        when(dataManager.loadConferences()).thenReturn(Single.<List<Conference>>just(new ArrayList<Conference>()));
    ...
    public void checkList() {
        ...
        when(dataManager.loadConferences()).thenReturn(Single.<List<Conference>>just(list));
        presenter.loadConferences();
    ...
    public void checkError() {
        ...
        when(dataManager.loadConferences()).thenReturn(Single.<List<Conference>>error(exception));
        presenter.loadConferences();
